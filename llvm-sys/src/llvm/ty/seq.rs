...
pub trait ArrayTypeExt: ::llvm::ty::seq::SequentialTypeExt {
    ...
    fn get_num_elements(&self) -> u64 {
        unsafe {
            let ret = ::ffi::llvm::ArrayType_getNumElements(::llvm::ty::seq::ArrayTypeExt::inner(self) as *const ::ffi::llvm_ArrayType) as u64;
            ret
        }
    }
}
...
impl ArrayType {
    ...
    pub fn classof(ty: &::llvm::ty::TypeExt) -> bool {
        unsafe {
            let ret = ::ffi::llvm::ArrayType_classof(::llvm::ty::TypeExt::inner(ty));
            ret
        }
    }
    ...
    pub fn get(element_type: &::llvm::ty::TypeExt, num_elements: u64) -> Option<::llvm::ty::seq::ArrayType> {
        unsafe {
            let ret = ::ffi::llvm::ArrayType_get(::llvm::ty::TypeExt::inner(element_type), num_elements as ::libc::uint64_t);
            if ret.is_null() {
                return None;
            }
    ...
    pub fn is_valid_element_type(ty: &::llvm::ty::TypeExt) -> bool {
        unsafe {
            let ret = ::ffi::llvm::ArrayType_isValidElementType(::llvm::ty::TypeExt::inner(ty));
            ret
        }
    }
}
...
pub trait PointerTypeExt: ::llvm::ty::seq::SequentialTypeExt {
    ...
    fn get_address_space(&self) -> u32 {
        unsafe {
            let ret = ::ffi::llvm::PointerType_getAddressSpace(::llvm::ty::seq::PointerTypeExt::inner(self) as *const ::ffi::llvm_PointerType) as u32;
            ret
        }
    }
}
...
impl PointerType {
    ...
    pub fn classof(ty: &::llvm::ty::TypeExt) -> bool {
        unsafe {
            let ret = ::ffi::llvm::PointerType_classof(::llvm::ty::TypeExt::inner(ty));
            ret
        }
    }
    ...
    pub fn get(element_type: &::llvm::ty::TypeExt, address_space: u32) -> Option<::llvm::ty::seq::PointerType> {
        unsafe {
            let ret = ::ffi::llvm::PointerType_get(::llvm::ty::TypeExt::inner(element_type), address_space as ::libc::c_uint);
            if ret.is_null() {
                return None;
            }
    ...
    pub fn get_unqual(element_type: &::llvm::ty::TypeExt) -> Option<::llvm::ty::seq::PointerType> {
        unsafe {
            let ret = ::ffi::llvm::PointerType_getUnqual(::llvm::ty::TypeExt::inner(element_type));
            if ret.is_null() {
                return None;
            }
            Some(::llvm::ty::seq::PointerType::from_inner(ret))
    ...
    pub fn is_valid_element_type(ty: &::llvm::ty::TypeExt) -> bool {
        unsafe {
            let ret = ::ffi::llvm::PointerType_isValidElementType(::llvm::ty::TypeExt::inner(ty));
            ret
        }
    }
}
...
pub trait SequentialTypeExt: ::llvm::ty::CompositeTypeExt {
    ...
    fn get_element_type(&self) -> Option<::llvm::ty::Type> {
        unsafe {
            let ret = ::ffi::llvm::SequentialType_getElementType(::llvm::ty::seq::SequentialTypeExt::inner(self) as *const ::ffi::llvm_SequentialType);
            if ret.is_null() {
                return None;
            }
...
impl SequentialType {
    ...
    pub fn classof(ty: &::llvm::ty::TypeExt) -> bool {
        unsafe {
            let ret = ::ffi::llvm::SequentialType_classof(::llvm::ty::TypeExt::inner(ty));
            ret
        }
    }
}
...
pub trait VectorTypeExt: ::llvm::ty::seq::SequentialTypeExt {
    ...
    fn get_bit_width(&self) -> u32 {
        unsafe {
            let ret = ::ffi::llvm::VectorType_getBitWidth(::llvm::ty::seq::VectorTypeExt::inner(self) as *const ::ffi::llvm_VectorType) as u32;
            ret
        }
    }
    ...
    fn get_num_elements(&self) -> u32 {
        unsafe {
            let ret = ::ffi::llvm::VectorType_getNumElements(::llvm::ty::seq::VectorTypeExt::inner(self) as *const ::ffi::llvm_VectorType) as u32;
            ret
        }
    }
}
...
impl VectorType {
    ...
    pub fn classof(ty: &::llvm::ty::TypeExt) -> bool {
        unsafe {
            let ret = ::ffi::llvm::VectorType_classof(::llvm::ty::TypeExt::inner(ty));
            ret
        }
    }
    ...
    pub fn get(ty: &::llvm::ty::TypeExt, num_elements: u32) -> Option<::llvm::ty::seq::VectorType> {
        unsafe {
            let ret = ::ffi::llvm::VectorType_get(::llvm::ty::TypeExt::inner(ty), num_elements as ::libc::c_uint);
            if ret.is_null() {
                return None;
            }
    ...
    pub fn get_double_elements_vector_type(ty: &::llvm::ty::seq::VectorTypeExt) -> Option<::llvm::ty::seq::VectorType> {
        unsafe {
            let ret = ::ffi::llvm::VectorType_getDoubleElementsVectorType(::llvm::ty::seq::VectorTypeExt::inner(ty));
            if ret.is_null() {
                return None;
            }
            Some(::llvm::ty::seq::VectorType::from_inner(ret))
    ...
    pub fn get_extended_element_vector_type(ty: &::llvm::ty::seq::VectorTypeExt) -> Option<::llvm::ty::seq::VectorType> {
        unsafe {
            let ret = ::ffi::llvm::VectorType_getExtendedElementVectorType(::llvm::ty::seq::VectorTypeExt::inner(ty));
            if ret.is_null() {
                return None;
            }
            Some(::llvm::ty::seq::VectorType::from_inner(ret))
    ...
    pub fn get_half_elements_vector_type(ty: &::llvm::ty::seq::VectorTypeExt) -> Option<::llvm::ty::seq::VectorType> {
        unsafe {
            let ret = ::ffi::llvm::VectorType_getHalfElementsVectorType(::llvm::ty::seq::VectorTypeExt::inner(ty));
            if ret.is_null() {
                return None;
            }
            Some(::llvm::ty::seq::VectorType::from_inner(ret))
    ...
    pub fn get_integer(ty: &::llvm::ty::seq::VectorTypeExt) -> Option<::llvm::ty::seq::VectorType> {
        unsafe {
            let ret = ::ffi::llvm::VectorType_getInteger(::llvm::ty::seq::VectorTypeExt::inner(ty));
            if ret.is_null() {
                return None;
            }
            Some(::llvm::ty::seq::VectorType::from_inner(ret))
    ...
    pub fn get_truncated_element_vector_type(ty: &::llvm::ty::seq::VectorTypeExt) -> Option<::llvm::ty::seq::VectorType> {
        unsafe {
            let ret = ::ffi::llvm::VectorType_getTruncatedElementVectorType(::llvm::ty::seq::VectorTypeExt::inner(ty));
            if ret.is_null() {
                return None;
            }
            Some(::llvm::ty::seq::VectorType::from_inner(ret))
    ...
    pub fn is_valid_element_type(ty: &::llvm::ty::TypeExt) -> bool {
        unsafe {
            let ret = ::ffi::llvm::VectorType_isValidElementType(::llvm::ty::TypeExt::inner(ty));
            ret
        }
    }
}
